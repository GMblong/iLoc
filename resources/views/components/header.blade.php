    ...
    <div class="middle_bar">
        <div class="auto-container">
            <div class="middle_bar_inner d-flex align-items-center justify-content-center justify-content-between gap-4 flex-wrap">
                <!-- Logo -->
                <div class="logo">
                    <a href="index.html" class="logo_default"><img src="assets/img/logo.png" style="width: 150px;" alt="img"></a>
                    <a href="index.html" class="logo_sticky"><img src="assets/img/logo.png" style="width: 150px;" alt="img"></a>
                </div>
